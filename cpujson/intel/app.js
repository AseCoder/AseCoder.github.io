...
function newCpu() {
	const component = new ComponentForm({ title: 'Unnamed CPU', parent: document.getElementById('components') })
		.addField({ name: 'name', placeholder: 'CPU Name, eg "Core i9-9900k"', key: 'name' })
		...
		.addField({ name: 'base clock speed', placeholder: 'x.xx GHz', omittable: true, type: 'number', key: 'base' })
		.addField({ name: 'boost clock speed', placeholder: 'x.xx GHz', omittable: true, type: 'number', key: 'boost' })
